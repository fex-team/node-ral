...
function loadRawConf(rawConf) {
    ...
    function validate(serviceID, serviceInfo) {
        ...
        RalModule.modules.converter.should.have.property(serviceInfo.pack);
        should(serviceInfo, 'unpack').to.be.a('string');
        RalModule.modules.converter.should.have.property(serviceInfo.unpack);
        should(serviceInfo, 'balance').to.be.a('string');
        RalModule.modules.balance.should.have.property(serviceInfo.balance);
        should(serviceInfo, 'protocol').to.be.a('string');
        RalModule.modules.protocol.should.have.property(serviceInfo.protocol);
