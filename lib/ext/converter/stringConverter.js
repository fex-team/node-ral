...
StringConverter.prototype.unpack = function (config, data) {
    ...
    try {
        ...
        logger.notice('unpack string data failed data=' + data + ' ServiceID=' + config.serviceID);
        throw e;
    }
...
StringConverter.prototype.pack = function (config, data) {
    ...
    try {
        ...
        logger.notice('pack string data failed data=' + data + ' ServiceID=' + config.serviceID);
        throw e;
    }
